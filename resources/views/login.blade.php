  ...
  <article>
    <section>
      ...
      <form action="/service/login" method="post">
        ...
        <div><input type="password" required class="input" id="password" name="password" placeholder="请输入密码,长度6~10"></div>
        ...
        <div>
          ...
          <!-- <div><input type="checkbox" name="remember" id="remember"><label for="remember">记住密码</label></div> -->
          <a href="/reset">忘记密码?</a>
        </div>
        <div>
